...
export type CartCreateMutation = { createOrder?: { id: string, total: number, createdAt: unknown, orderItems: Array<{ id: string, total: number, quantity: number, product?: { id: string, name: string, price: number, description: string, images: Array<{ url: string }>, categories: Array<{ id: string, name: string }> } | null }> } | null };
...
export type CartGetByIdQuery = { order?: { id: string, total: number, createdAt: unknown, orderItems: Array<{ id: string, total: number, quantity: number, product?: { id: string, name: string, price: number, description: string, images: Array<{ url: string }>, categories: Array<{ id: string, name: string }> } | null }> } | null };

export type CartOrderFragment = { id: string, total: number, createdAt: unknown, orderItems: Array<{ id: string, total: number, quantity: number, product?: { id: string, name: string, price: number, description: string, images: Array<{ url: string }>, categories: Array<{ id: string, name: string }> } | null }> };
...
export type CartUpdateItemMutation = { updateOrderItem?: { id: string } | null };
...
export type OrdersGetByEmailQuery = { orders: Array<{ id: string, total: number, createdAt: unknown, orderItems: Array<{ id: string, total: number, quantity: number, product?: { id: string, name: string, price: number, description: string, images: Array<{ url: string }>, categories: Array<{ id: string, name: string }> } | null }> }> };
...
export type ProductListItemFragment = { id: string, name: string, description: string, price: number, categories: Array<{ name: string }>, images: Array<{ url: string }>, reviews: Array<{ rating: number }> };
...
export type ProductsGetByCategorySlugQuery = { categories: Array<{ name: string, products: Array<{ id: string, name: string, description: string, price: number, categories: Array<{ name: string }>, images: Array<{ url: string }>, reviews: Array<{ rating: number }> }> }> };
...
export type ProductsGetByCollectionSlugQuery = { collections: Array<{ name: string, description?: string | null, products: Array<{ id: string, name: string, description: string, price: number, categories: Array<{ name: string }>, images: Array<{ url: string }>, reviews: Array<{ rating: number }> }> }> };
...
export type ProductsGetListQuery = { productsConnection: { pageInfo: { pageSize?: number | null } }, products: Array<{ id: string, name: string, description: string, price: number, categories: Array<{ name: string }>, images: Array<{ url: string }>, reviews: Array<{ rating: number }> }> };
...
export type ProductsSearchByQueryQuery = { products: Array<{ id: string, name: string, description: string, price: number, categories: Array<{ name: string }>, images: Array<{ url: string }>, reviews: Array<{ rating: number }> }> };
...
export type ReviewGetByProductIdQuery = { reviews: Array<{ headline: string, content: string, name: string, email: string, rating: number }> };

export type ReviewListItemFragment = { headline: string, content: string, name: string, email: string, rating: number };
